...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void SClickTest()
        {
            ...
            Navigation.SwitchFrames("name", "frame2");
            ElementHelper.WaitTilReady("id", "bolDate", 15);
            SeleniumSetMethods.iEnterText("id", "bolDate", bolDate);
            //Console.WriteLine((SeleniumSetMethods.iEnterText(bolDate, "id", "bolDate")));

            Console.WriteLine(SeleniumUtilities.LineNumber() + (MouseActions.iClick("xp", "//body[@class='tundra']//td//td[1]//input[1]")));
            Navigation.SwitchFrames("name", "frame2");
